...
open class Notesx5ICalObject(val account: Account, val client: ContentProviderClient, collectionId: Long, component: X5ICalObject.Component) {
    ...
    fun delete(): Int {
        return client.delete(ContentUris.withAppendedId(X5ICalObject.CONTENT_URI.asSyncAdapter(account), requireNotNull(id)), null, null)
    }
    ...
    fun write(os: OutputStream) {
        // TODO vgl. Methode in Event.kt um das ical-file zu erzeugen
        os.write("TEST-ICAL".toByteArray())
    }
